...
//  Scrumdinger
//
//  Created by Wesley Van der Klomp on 12/31/20.
//
...
struct MeetingFooterView_Previews: PreviewProvider {
    static var speakers = [ScrumTimer.Speaker(name: "Kim", isCompleted: false), ScrumTimer.Speaker(name: "Steve", isCompleted: false)]
