...
class RectNode: SKShapeNode {
    ...
    ///
    /// A value of (0.0, 0.0) is the top left and (1.0, 1.0) is bottom right. Defaults to 0.5, 0.5 which dead center. Set anchorPoint, then set the position property to see effects. Works much like SKSpriteNode's implementation.
